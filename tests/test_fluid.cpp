...
TEST_CASE("Fluid - 8 particles fall without distance constraints") {
    ...
    cfg.radius = 0.1f;   cfg.gravity = -9.8f;
    cfg.gridRes = 16;
...
TEST_CASE("Fluid - 8 particles fall with distance constraints (no overlap)") {
    ...
    cfg.N = N;
    cfg.worldMin = 0.0f; cfg.worldMax = 10.0f;
    cfg.radius = RADIUS; cfg.gravity = -9.8f;
    cfg.gridRes = 16;
    cfg.numSubsteps = 4; cfg.solverIterations = 4;
    cfg.typeFlag = 0;    cfg.selfCollision = true;   // ← 拘束あり
...
TEST_CASE("Fluid 2D - particles fall in box, no constraints") {
    ...
    cfg.gridRes = 16;
    cfg.numSubsteps = 4; cfg.solverIterations = 4;
    cfg.typeFlag = 0;    cfg.selfCollision = false;
...
TEST_CASE("Fluid 2D - particles fall in box, with constraints") {
    ...
    cfg.gridRes = 16;
    cfg.numSubsteps = 4; cfg.solverIterations = 4;
    cfg.typeFlag = 0;    cfg.selfCollision = true;
