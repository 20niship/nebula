...
struct CowBlastArgs : public argparse::Args {
  ...
  int& pressure_iters  = kwarg("pressure-iters", "圧力投影 Red-Black Gauss-Seidel sweep回数").set_default(20);
  ...
  std::string& cow_stl = kwarg("cow-stl", "牛 STL パス").set_default(ASSET_DIR_STR + "/cow_obstacle.stl");
