...
public:
  ...
  void init(const HeadlessCtx& ctx, uint32_t gridRes, float worldSize, const std::string& shaderDir, uint32_t maxParticles = 64);
  ...
  MPMSimPC makePC(float dt, float rho0 = 1000.0f, float mu = 5000.0f, float lam = 11538.0f, float gravity = 0.0f);
